...
# choose BIN file:
#path <- file.choose()
#path <- "C:\\Users\\dm59leto\\Desktop\\RT-SAR\\FB_10Gy_SAR_RT.bin"
...
record_type <- "OSL"
drop_selection <- 11 # NULL #which aliquots to leave out?

# values from Maggis Sibirian data sets
dose_rate <- 1 #4.95 / 60 # Gy/s
age_rate <- 1 #0.635 # ka/Gy
...
global_output <- data.frame(lambda = round(global_components$lambda, digits = 4),
                            ...
                            cross_section = paste0(format(global_components$cross.section, digits = 3, scientific = TRUE)," cm²"),
