...
-   y-axis does not scale correctly in case of negative components

-   no warning message if show.xxx is not possible due to missing information
...
tryCatch({plot_OSLcurve(case$curve)}, 
         error = function(e) {
           message("FOUND ERROR", conditionMessage(e))
})
