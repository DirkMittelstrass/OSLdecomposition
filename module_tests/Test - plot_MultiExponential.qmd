...
## Stacked plots with linear axes

```{r}

for (case in cases) {
  plot_MultiExponential(case$curve, case$components, component.type = "fill")
}

#plot_MultiExponential(curve, components, component.type = "fill")
#plot_MultiExponential(curve, components, component.type = "fill", scaling.type = "log")
```
