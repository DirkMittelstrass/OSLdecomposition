...
De_fast_component <- analyse_SAR.CWOSL_decomposed(OSLdata_decomposed, OSL.component = 1)
De_medium_component <- analyse_SAR.CWOSL_decomposed(OSLdata_decomposed, OSL.component = 2)
