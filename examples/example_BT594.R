...
results_decomposed <- analyse_SAR.CWOSL_decomposed(BT594, OSL.component = "fast")

results_late_background <- analyse_SAR.CWOSL_decomposed(BT594, 1, 3, 80, 100, plot = FALSE)
