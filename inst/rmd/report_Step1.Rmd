...
# Add the following lines to the YAML header to enable offline display of the equations:
#   mathjax: local
#   self_contained: false

Last_changed <- "2021-02-15"
...
# Table caption:
cat(paste0("<br><i><b>Table 2:</b> Decay rates and fitting quality parameters as function of component number $K$. <br>$RSS$: Residual square sum. $F_K$:  Measure of fitting improvement.</i><br>", K.default.text, " <u>Blue stripe</u>: F-test selected model.<br>"))

# print F-test table (may add the bootstrap_options "striped")
