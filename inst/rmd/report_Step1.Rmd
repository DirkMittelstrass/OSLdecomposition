...
K.selected <- fit_data$K.selected
n.figure <- 1
```
...
for (i in 1:nrow(fit_data$F.test)) {
 ...
 # cat(paste0("<pre>**Figure ", n.figure,":** "))
  cat(paste0("<br>*Figure ", n.figure,": Global mean curve fit with K = ", i, 
             " components*<br><br>"))
n.figure <- n.figure + 1
...
plot_PhotoCrosssections(fit_data,
                        stimulation.intensity = fit_data$fit.arguments$stimulation.intensity,
                        stimulation.wavelength = fit_data$fit.arguments$stimulation.wavelength)
