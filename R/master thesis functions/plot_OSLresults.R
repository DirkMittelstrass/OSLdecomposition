#' Advanced plot function for OSL decomposition results
#'
#' @param curve

#' @section Changelog:
#' * 2019-10-28, DM: First reasonable version

#'
#' @section ToDo:
#' * #'
#'
#' @section Last changed. 2019-10-28
#'
#' @author
...
plot_OSLresults <- function(data,
  ...
  if ((display == "components") || (display == "detailed") ||
    ...
    ######################## LOG LOG PLOT #########################################################
    if (display == "detailed" || (display == "compare_lin") || (display == "compare_log")) {
